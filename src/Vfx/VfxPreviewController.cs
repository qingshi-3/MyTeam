...
public partial class VfxPreviewController : Control, IVfxStage
{
    ...
    private void Replay()
    {
        ...
        GetNode<HSlider>("%Width").Editable = definition.StretchBetween;
    ...
    private VfxContext PreviewContext(VfxDefinition definition) => new(-PreviewDirection * _distance / 2, PreviewDirection * _distance / 2,
